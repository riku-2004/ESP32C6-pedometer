...
#define MRBC_COPRO_GC_B8_COUNT 32
#define MRBC_COPRO_GC_B8_ALIGN_START 0
#define MRBC_COPRO_GC_B8_ALIGN_REGION_START (MRBC_COPRO_GC_B8_ALIGN_START + (MRBC_COPRO_GC_B8_COUNT / 32 * 3)) // 3
// 8 Bytes aligned space is bigger
#define MRBC_COPRO_GC_B16_COUNT 32
#define MRBC_COPRO_GC_B16_ALIGN_START (MRBC_COPRO_GC_B8_ALIGN_REGION_START + MRBC_COPRO_GC_B8_COUNT*2) // 67
#define MRBC_COPRO_GC_B16_ALIGN_REGION_START (MRBC_COPRO_GC_B16_ALIGN_START + (MRBC_COPRO_GC_B16_COUNT / 32 * 3)) // 70
#define MRBC_COPRO_GC_B32_COUNT 32
#define MRBC_COPRO_GC_B32_ALIGN_START (MRBC_COPRO_GC_B16_ALIGN_REGION_START + MRBC_COPRO_GC_B16_COUNT*4) // 198
#define MRBC_COPRO_GC_B32_ALIGN_REGION_START (MRBC_COPRO_GC_B32_ALIGN_START + (MRBC_COPRO_GC_B32_COUNT / 32 * 3)) // 201
// 64 Bytes or bigger space. different management.
#define MRBC_COPRO_GC_BIGGER_START (MRBC_COPRO_GC_B32_ALIGN_REGION_START + MRBC_COPRO_GC_B32_COUNT*8) // 457
#define MRBC_COPRO_GC_BIGGER_ALIGN 8 // 4 * 8 (=32) bytes align
#define MRBC_COPRO_GC_BIGGER_COUNT 32 // reduced to fit in 512
...
#define MRBC_COPRO_GC_BIGGER_REGION_START (MRBC_COPRO_GC_BIGGER_START + (MRBC_COPRO_GC_BIGGER_COUNT / 32 * 4)) // 461
